...
const index = () => {
  ...
  const list_items_2 = [
    { label: "LinkedIn", url: "https://www.linkedin.com/in/izzyprior" },
    { label: "Instagram", url: "https://www.instagram.com/izzypriortalks/" }
  ]
  ...
  return (
    <section className="relative h-[450px] md:h-[650px] lg:min-h-screen overflow-hidden flex flex-col justify-between">
      ...
      <div className="flex justify-center font-noto-serif md:-mb-[30px] 2xl:-mb-[70px]">
        <p className="text-[16vw] 2xl:text-[260px] font-medium">IZZY PRIOR</p>
      </div>
    </section>
  )
}
